...
Calendar component will be custom built with dnd-kit
date-fns for date stuff
Vercel cron for background bits
Error tracking? Sentry
react-hook-form + zod

# Other notes

Will be using an ORM, but documenting all SQL generated by it.

User settings should be initially configured during an onboarding process. This onboarding process should be thought out and developed further later down the line.
